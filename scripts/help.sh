...
[${BLUE}Manage${NC}]
  ...
  igm restart         [name] [--all|--proxy]     Restart one or more deployed applications.
...
[${BLUE}Proxy${NC}]
  ...
  igm proxy setup                                Setup proxy applications for deployment.
...
[${BLUE}Configuration${NC}]
  ...
  igm setup                                      Setup configuration for deployment.
